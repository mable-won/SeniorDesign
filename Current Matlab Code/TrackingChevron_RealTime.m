    ...
    figure(1),imshow(CamImage);
        ...
        if(size(centroids))
            ...
            plot(centroids(:,1),centroids(:,2), 'b*')
             ...
             %the centroid along the axis line. From there, the program
             %chose the sample point that is white. Take tan2 of the white
             %sample point and the centroid outputs the 360 orientation
             ...
             %-----------Drawing orientation line and number of dots-----%
             for i = 1:numel(ch)
